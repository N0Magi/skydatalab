...
export default {
    ...
    props: {
        ...
        highlight: Boolean,
        lazy: Boolean,
        lazyTopHeight: Number,
        lazyBottomHeight: Number
    },
    ...
    render(h) {
        ...
        return (
            <table
                ...
                <tbody>
                    {
                        this.lazy && <tr style={{ height: `${this.lazyTopHeight}px`, opacity: '0.5' }}/>
                    }
                    {
                    ...
                    {
                        this.lazy && <tr style={{ height: `${this.lazyBottomHeight}px`, opacity: '0.5' }}/>
                    }
                </tbody>
            </table>
        );
